...
生成的JAR文件位于：`build/libs/mystisql-jdbc-1.0.0-SNAPSHOT.jar`

## 版本兼容性

| JDBC Driver版本 | MystiSql Gateway版本 | Java版本 | JDBC版本 |
|----------------|---------------------|----------|----------|
| 1.0.x          | 1.0.x               | 8+       | 4.2      |
...
- ❌ 事务管理（commit/rollback） - Phase 3
- ❌ 批量操作（addBatch/executeBatch） - Phase 3
- ❌ WebSocket支持 - Phase 3
