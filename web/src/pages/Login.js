...
export default function Login() {
    ...
    return (_jsx("div", { style: {
        ...
        }, children: _jsxs(Card, { style: { width: 400, boxShadow: '0 4px 12px rgba(0,0,0,0.15)' }, children: [_jsxs("div", { style: { textAlign: 'center', marginBottom: 24 }, children: [_jsx(Title, { level: 2, style: { marginBottom: 8 }, children: "MystiSql" }), _jsx(Typography.Text, { type: "secondary", children: "\u6570\u636E\u5E93\u8BBF\u95EE\u7F51\u5173" })] }), _jsxs(Form, { form: form, onFinish: handleSubmit, layout: "vertical", initialValues: { role: 'readonly' }, children: [_jsx(Form.Item, { name: "userId", label: "\u7528\u6237 ID", rules: [{ required: true, message: '请输入用户 ID' }], children: _jsx(Input, { "data-testid": "user-id-input", prefix: _jsx(UserOutlined, {}), placeholder: "\u8BF7\u8F93\u5165\u7528\u6237 ID", size: "large" }) }), _jsx(Form.Item, { name: "role", label: "\u89D2\u8272", rules: [{ required: true, message: '请输入角色' }], children: _jsx(Input, { "data-testid": "role-input", prefix: _jsx(LockOutlined, {}), placeholder: "\u8BF7\u8F93\u5165\u89D2\u8272\uFF08\u5982\uFF1Aadmin\u3001readonly\uFF09", size: "large" }) }), _jsx(Form.Item, { children: _jsx(Button, { "data-testid": "login-button", type: "primary", htmlType: "submit", loading: loading, block: true, size: "large", children: "\u767B\u5F55" }) })] }), _jsx(Typography.Text, { type: "secondary", style: { display: 'block', textAlign: 'center' }, children: "\u4F7F\u7528 Token \u8BA4\u8BC1\u767B\u5F55" })] }) }));
}
